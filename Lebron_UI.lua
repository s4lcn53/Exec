...
local ICONS = {
    NOTIF_ICON_ID = "rbxassetid://11401835376",
    MOBILE_ICON_ID = "rbxassetid://18817519330",
    ICON_ERROR = "rbxassetid://11401835376",
    ICON_DEFAULT = "rbxassetid://11401835376"
}
...
local function SendNotification(text, color, customIcon)
    ...
    Icon.Image = ICONS.NOTIF_ICON_ID -- Use custom or default
...
SendNotification("Yokai V94 Loaded", Color3.fromRGB(0, 255, 100), ICONS.ICON_DEFAULT)
...
ToggleBtn.Image = ICONS.MOBILE_ICON_ID
